    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-zinc-200 divide-y divide-zinc-100">
      ...
      <div className="p-6 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            required
            className="border border-zinc-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 ring-brand focus:border-transparent max-w-sm"
          />
        </div>
      ...
      <div className="p-6 flex items-center gap-4">
        <button
          ...
          className="bg-brand text-white rounded-lg px-5 py-2 text-sm font-semibold hover:brightness-110 transition-all disabled:opacity-50"
        >
